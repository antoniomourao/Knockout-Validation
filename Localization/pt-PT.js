...
ko.validation.localize({
    ...
    max: 'Por favor, indique um valor menor ou igual a {0}.',
    minLength: 'Por favor, indique pelo menos {0} caracteres.',
    maxLength: 'Por favor, não indique mais que {0} caracteres.',
    pattern: 'Por favor, verifique este valor',
    step: 'O valor deve ser incrementado por {0}',
    email: 'Por favor, indique um endereço eletrónico válido.',
    date: 'Por favor, indique uma data válida.',
    dateISO: 'Por favor, indique uma data válida (ISO).',
    number: 'Por favor, indique um número válido.',
    digit: 'Por favor, indique somente dígitos.',
    phoneUS: 'Por favor, indique um telefone válido',
